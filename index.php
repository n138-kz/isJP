...
header("Access-Control-Allow-Headers: Content-Type, Content-Length, Origin, Accept, Access-Control-Allow-Headers");

class IsJP {
	public const FLAG_JSON_ENCODE = JSON_INVALID_UTF8_IGNORE | JSON_UNESCAPED_SLASHES;
